...
@testset "JSpecAstro.jl" begin
    ...
    #
    # FindRebinSchema
    @test JSpecAstro.FindRebinSchema([1.,2.,3.,4.,],[0.1,0.5,0.6,0.05]) == [1, 3, 4]
    #
    # GenRebin
    @test JSpecAstro.GenRebin([1.,2.,3.,4.],[1,3,4]) == [1.0,2.5,4.0]
    #
    # RebinData
    RebinData(newdt)
    ...
    @test JSpecAstroFunc([1.,2.],[newodt,],Myfunc) == [3.0,6.0,9.0,12.0]
    #
    # Angstrom2KeV
